...
import request from 'superagent';
   ...
   * @param {function(error:any, {results:object[], elapsedTime:number})} callback the callback function providing the outcome
   */
  ...
  function serviceRequest(method, uri, qs, callback, token, mimeType, formData) {
      ...
      req.end(function (err, res) {
          ...
          callback(err, res ? (res.body || res.text) : null);
      });
  }
